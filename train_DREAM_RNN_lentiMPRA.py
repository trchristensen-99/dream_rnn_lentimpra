...
Standalone version - no dependencies on parent repository structure.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="DREAM_RNN_lentiMPRA.yaml", help="Config file")
